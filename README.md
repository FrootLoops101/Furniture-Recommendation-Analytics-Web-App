...
2. Product favorites and history
3. Advanced filtering options
4. Image-based search (CV integration)
5. Multi-language support

### Medium-term
1. Fine-tune embedding model on furniture corpus
...
### Long-term
1. Recommendation explanation (interpretability)
2. Real-time inventory integration
3. Purchase tracking and analytics
...
**Built with AI, designed for users, optimized for performance.**
